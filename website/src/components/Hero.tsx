    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100 pt-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="group px-8 py-4 bg-[color:var(--accent)] hover:bg-[color:var(--accent)]/90 text-white font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-xl hover:shadow-[color:var(--accent)]/30 transform hover:-translate-y-0.5"
          >
            Umów wizytę
        ...
        <div className="mt-16 pt-16 border-t border-slate-200">
          <p className="text-slate-600 text-sm mb-4 font-medium">Zaufało nam już ponad 500+ klientów</p>
          <div className="flex justify-center gap-8 flex-wrap">
            <div className="text-center">
              <p className="text-3xl font-bold text-slate-900">12+</p>
              <p className="text-slate-600 text-sm">Lat doświadczenia</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-slate-900">500+</p>
              <p className="text-slate-600 text-sm">Zadowolonych klientów</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-slate-900">⭐ 4.9</p>
              <p className="text-slate-600 text-sm">Średnia ocen</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
        <div className="flex flex-col items-center gap-2 animate-bounce">
          <span className="text-slate-600 text-xs font-medium">Scrolluj poniżej</span>
